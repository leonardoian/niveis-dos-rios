...
// Busca a leitura mais recente (últimas 48h) de cada uma das 12 estações
...
export async function buscarNiveisAna() {
  ...
  for (const resultado of resultados) {
    ...
    // Mais de um registro por estação na janela de 48h (DIAS_2, ver
    // buscarLote) — fica só com o mais recente por Data_Hora_Medicao,
    // mesmo critério de "leitura atual" usado no resto do sistema.
